...
export default function ProtectedFrame({
  ...
  return (
    /* Once shown, the chart opens large like any other picture; the lightbox
       loads the same gated URL, which the cookie already unlocks. */
    <Zoomable
      picture={{ ...picture, src: picture.protectedSrc }}
      disabled={!shown}
    >
      <div
        ...
        {!shown && (
          <div className="absolute inset-0 grid place-items-center">
            ...
            <span className="sr-only">
              Chart hidden until unlocked: {picture.alt}
            </span>
          </div>
        )}
      </div>
